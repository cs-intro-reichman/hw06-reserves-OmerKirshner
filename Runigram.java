...
public class Runigram {
    ...
    public static Color[][] flippedHorizontally(Color[][] image) {
        int rows = image.length;
        int cols = image[0].length;
        Color[][] flippedHorz = new Color[rows][cols];
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < cols; j++) {
                flippedHorz[i][j] = image[i][cols - 1 - j];
            }
        }
        return flippedHorz;
    }
    ...
    public static Color[][] flippedVertically(Color[][] image) {
        int rows = image.length;
        int cols = image[0].length;
        Color[][] flippedVert = new Color[rows][cols];
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < cols; j++) {
                flippedVert[i][j] = image[rows - 1 - i][j];
            }
        }
        return flippedVert;
    }
    ...
    public static Color[][] grayScaled(Color[][] image) {
        int rows = image.length;
        int cols = image[0].length;
        Color[][] greypic = new Color[rows][cols];
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < cols; j++) {
    ...
    public static Color[][] scaled(Color[][] image, int width, int height) {
        ...
        for (int i = 0; i < height; i++) {
            for (int j = 0; j < width; j++) {
                int origwidth = j * image[0].length / width;
                int origHeight = i * image.length / height;
                scale[i][j] = image[origHeight][origwidth];
            }
        }
